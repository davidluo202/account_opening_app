      ...
      <div className="space-y-6">
        ...
        <Card className="p-6 space-y-4">
          ...
          <div className="flex items-start space-x-2 mt-2">
            ...
            />
            <Label htmlFor="objectsDirectMarketing" className="cursor-pointer font-normal text-sm">
              ☐ The customer named objects to the proposed use of his/her personal data in direct marketing. 本人（姓名如下）反對使用個人資料於擬作出的直接促銷
            </Label>
          </div>
        </Card>
        ...
        <Card className="p-6 space-y-4">
          ...
          <p className="text-xs text-muted-foreground leading-tight" style={{marginBottom: '1px'}}>
            我確認（i）已收到、閱讀及明白本公司附上之現金賬戶協定；（ii）同意接受該現金賬戶協定所約束；及（iii）同意如客戶資料表內之詞彙表達與該現金賬戶協定有任何抵觸，該現金賬戶協定將凌駕於客戶資料表。
          </p>
          <p className="text-xs text-muted-foreground leading-tight" style={{marginTop: '1px'}}>
