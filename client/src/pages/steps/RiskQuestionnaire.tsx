...
export default function RiskQuestionnaire() {
  ...
  useEffect(() => {
    if (savedData) {
      setFormData({
        ...
        q9_investment_knowledge_sources: savedData.q9_investment_knowledge_sources || "",
  ...
  const handleSave = () => {
    ...
    saveMutation.mutate({
      ...
      onError: (error: any) => {
        toast.error("保存失敗: " + (error.message || "請稍後再試"));
      }
    });
  };
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="no_adequate_knowledge" id="q9-no-adequate-knowledge" />
                  <Label htmlFor="q9-no-adequate-knowledge">B. No, but we have adequate knowledge on making investment decisions. 否, 但本公司對投資決定有足夠相關知識。</Label>
                </div>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="yes_little_knowledge" id="q9-yes-little-knowledge" />
                  <Label htmlFor="q9-yes-little-knowledge">C. Yes, but we have only some or little knowledge on making investment decisions. 是，但本公司對投資決定只有一些或少許相關知識。</Label>
                </div>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="yes_adequate_knowledge" id="q9-yes-adequate-knowledge" />
                  <Label htmlFor="q9-yes-adequate-knowledge">D. Yes, we have senior management with adequate knowledge to make investment decisions. 是，本公司有足夠相關知識的管理層作出投資決定。</Label>
                </div>
              </RadioGroup>
